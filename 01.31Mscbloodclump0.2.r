...
# Rscript 01.31Mscbloodclump0.2.r 2>&1 | tee 01.31Mscbloodclump0.2.r.log

# ==============================================================================
# 配置区 
# ==============================================================================
WORK_DIR       <- "~/publicdata/datasets/eqtl/1mscblood"
INPUT_FILE     <- "1mscblood_filtered_exposure.qs"
OUTPUT_FILE    <- "1mscblood_Exposure_clump0.2.qs"
...
PLINK_BFILE    <- "/home/piperacillin/publicdata/rawinstruments/EUR"
N_CORES        <- 20
CLUMPR <- 0.2
...
log_msg(paste("Clump 完成。保留独立exposure 总数:", length(unique(clumped_df$id.exposure))))
