...
# Rscript 01.6onek1kclump0.01.r 2>&1 | tee 01.6onek1kclump0.01.r.log

# ==============================================================================
# 配置区 
# ==============================================================================
WORK_DIR       <- "~/publicdata/datasets/eqtl/onek1k"
INPUT_FILE     <- "onek1k_filtered_exposure.qs"
OUTPUT_FILE    <- "onek1k_Exposure_clump0.01.qs"
