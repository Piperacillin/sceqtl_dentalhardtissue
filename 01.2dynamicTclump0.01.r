...
# Rscript 01.2dynamicTclump0.01.r 2>&1 | tee 01.2dynamicTclump0.01.r.log

# ==============================================================================
# 配置区 
# ==============================================================================
WORK_DIR       <- "~/publicdata/datasets/eqtl/CD4Tdynamic"
INPUT_FILE     <- "CD4_Dynamic_Exposure.qs"
OUTPUT_FILE    <- "CD4_Dynamic_Exposure_clump0.01.qs"
...
# ==============================================================================
log_msg("正在进行 Clump 冒烟测试 (测试前 2 个 ID)...")

test_ids <- unique(dt_valid$id.exposure)[1:2]
